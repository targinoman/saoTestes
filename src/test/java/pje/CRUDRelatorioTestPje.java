...
public class CRUDRelatorioTestPje extends BaseTestMultiplosPje {

	@Test
	public void AcriarRelatorio() {
		page.acessaURL("https://pjehomologacao.trt13.jus.br/sao/administrativo/consultas/cadastro");
		...
		page.escreveClasse("mat-chip-input", "advogado");
	...
	public void BeditarRelatorio() {
		page.acessaURL("https://pjehomologacao.trt13.jus.br/sao/administrativo/consultas/");
