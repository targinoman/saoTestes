...
public class CRUDParametroTestAdm extends BaseTestMultiplosAdm {

	@Test
	public void AcriarParametro() {
		page.acessaURL("https://saoadmhomologacao.trt13.jus.br/sao/administrativo/parametros/cadastro");
	...
	public void BeditarParametro() {
		page.acessaURL("https://saoadmhomologacao.trt13.jus.br/sao/administrativo/parametros");
