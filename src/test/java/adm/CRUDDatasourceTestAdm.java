...
public class CRUDDatasourceTestAdm extends BaseTestMultiplosAdm {

	@Test
	public void AcriarDatasource() {
		page.acessaURL("https://saoadmhomologacao.trt13.jus.br/sao/administrativo/datasources/cadastro");
		...
		page.esperaClasse("titulo-consulta");
	...
	public void BeditarDatasource() {
		page.acessaURL("https://saoadmhomologacao.trt13.jus.br/sao/administrativo/datasources");
